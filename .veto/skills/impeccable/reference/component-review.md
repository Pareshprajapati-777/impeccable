...
Otherwise run `.veto/skills/impeccable/scripts/impeccable component-review capture --manifest .impeccable/review/components.json`, then start `.veto/skills/impeccable/scripts/impeccable component-review serve --session <returned session>` in the background. Open the URL it prints in the available browser and wait for the user. Read the result with `.veto/skills/impeccable/scripts/impeccable component-review verify --manifest .impeccable/review/components.json`; pending, needs-work and stale input all refuse approval. Never submit the page or write a receipt on the user's behalf.
